...
void initRender(OpenGL *ogl)
{
	...
	*/
	...
	loadModel("models\\1.obj", &myHome);
	loadModel("models\\2.obj", &objModel);
	mainTexture.loadTextureFromFile("textures\\1.bmp");
	isMain = true;
...
void Render(OpenGL* ogl)
{
	...
	*/
	...
	glTranslated(0, 0, 0);
	glRotated(roar, 0, 0, 1);
	glTranslated(alfa, 0, 0);
	glRotated(90, 1, 0, 0);
	objModel.DrawObj(GL_TRIANGLES);
	glPopMatrix();
	//s[0].UseShader();
